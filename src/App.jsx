...
const AIRLINES = [
  // ── AUSTRALIAN / PACIFIC ──────────────────────────────────────────────────
  {name:"Qantas",code:"QF",logo:"🦘",
   formName:"Travel Clearance Form",leadTime:"5 days prior",
   requirements:["Travel Clearance Form completed by treating physician","Accessibility, Medical & Inclusion Request Form submitted","Fit to fly assessment","Equipment manifest if required"],
   formUrl:"https://www.qantas.com/content/dam/qantas/pdfs/fly/specific-needs/qantas-medical-clearance-guidelines.pdf",
   pageUrl:"https://www.qantas.com/au/en/travel-info/specific-needs/fitness-to-fly.html",
   notes:"Qantas renamed MEDA to 'Travel Clearance Form'. Submit 5 days prior (not 48hrs). Call Qantas Specific Needs: 1800 177 474 (AU) or +61 2 9123 7471 opt 3.",
   stretch:true,equip:true},

  {name:"Air New Zealand",code:"NZ",logo:"🥝",
   formName:"MEDA Medical Clearance",leadTime:"48 hrs prior",
   requirements:["Medical clearance form completed by physician","Physician sign-off","Escort registration","Equipment manifest if applicable"],
   formUrl:"https://www.airnewzealand.com.au/special-assistance",
   pageUrl:"https://www.airnewzealand.com.au/special-assistance",
   notes:"Good for trans-Tasman and Pacific repatriation. Does not accept stretcher cases on most routes.",
   stretch:false,equip:true},

  // ── MIDDLE EAST ───────────────────────────────────────────────────────────
  {name:"Emirates",code:"EK",logo:"✈",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF Part 1 — passenger section","MEDIF Part 2 — physician section","Fit to Fly declaration","Equipment approval from Emirates Medical"],
   formUrl:"https://c.ekstatic.net/ecl/documents/before-you-fly/emirates-medif-form.pdf",
   pageUrl:"https://www.emirates.com/english/before-you-fly/medical-requirements/",
   notes:"All O2 must be Emirates-supplied. Dedicated medical desk. Submit via local Emirates office.",
   stretch:true,equip:true},

  {name:"Etihad",code:"EY",logo:"🌙",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF completed by physician","Fit to fly certificate","Medical equipment approval","Escort credential verification"],
   formUrl:"https://www.etihad.com/content/dam/eag/etihadairways/etihadcom/Global/pdf/MEDIF-form.pdf",
   pageUrl:"https://www.etihad.com/en/fly-etihad/onboard/special-assistance",
   notes:"Etihad Medical Services reviews all submissions. Allow extra time for complex cases.",
   stretch:true,equip:true},

  {name:"Qatar Airways",code:"QR",logo:"🌟",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF signed by treating physician","Fit to fly declaration","Equipment manifest","Escort qualification documentation"],
   formUrl:"https://sleeprestfully.com/wp-content/uploads/2024/05/qater_airways.pdf",
   pageUrl:"https://www.qatarairways.com/en-au/homepage/special-assistance/",
   notes:"Excellent business class facilities for medical cases. DOH hub suits Middle East repatriation. Submit to any Qatar Airways Sales Office.",
   stretch:true,equip:true},

  // ── ASIA ──────────────────────────────────────────────────────────────────
  {name:"Singapore Airlines",code:"SQ",logo:"🦁",
   formName:"MEDIF SAL018R",leadTime:"48 hrs prior",
   requirements:["MEDIF Part 1 — passenger","MEDIF Part 2 — physician","In-flight O2 pre-approval if required","Escort registration"],
   formUrl:"https://www.singaporeair.com/content/dam/sia/web-assets/pdfs/travel-info/medif/MEDIF-SAL018R-SEP25.pdf",
   pageUrl:"https://www.singaporeair.com/en_UK/au/travel-info/special-assistance/medical-information/",
   notes:"Very accommodating for repatriation. Updated form Sept 2025. Contact local SIA office 48hrs prior.",
   stretch:true,equip:true},

  {name:"Cathay Pacific",code:"CX",logo:"🐉",
   formName:"MEDA Form Part 1 & 2",leadTime:"48 hrs prior (72 hrs for O2)",
   requirements:["MEDA Form Part 1 — passenger","MEDA Form Part 2 — physician (in English)","Current clinical registration for escort","Equipment manifest"],
   formUrl:"https://www.cathaypacific.com/content/dam/cx/travel-information/special-assistance/medical-assistance/cx-meda-form-part-1_191224.pdf",
   pageUrl:"https://www.cathaypacific.com/cx/en_AU/travelling-information/special-assistance/medical-assistance.html",
   notes:"Updated Dec 2024 form. O2 requests need 72hr notice. Submit both Part 1 & 2 to local CX Reservations.",
   stretch:true,equip:true},

  {name:"Thai Airways",code:"TG",logo:"🌺",
   formName:"MEDA Form",leadTime:"72 hrs prior",
   requirements:["MEDA form signed by physician","Fit to Fly declaration","Equipment pre-approval","Escort qualification letter"],
   formUrl:"https://www.thaiairways.com/en/travel_information/special_needs/medical.page",
   pageUrl:"https://www.thaiairways.com/en/travel_information/special_needs/medical.page",
   notes:"72hr notice required — plan ahead. Good BKK gateway for SE Asia repatriation.",
   stretch:true,equip:false},

  {name:"Malaysia Airlines",code:"MH",logo:"🌙",
   formName:"MEDA Form",leadTime:"48 hrs prior",
   requirements:["MEDA form","Medical certificate","Escort credentials","Equipment list"],
   formUrl:"https://www.malaysiaairlines.com/my/en/site-help/special-assistance.html",
   pageUrl:"https://www.malaysiaairlines.com/my/en/site-help/special-assistance.html",
   notes:"Contact MH medical desk directly for stretcher cases. KUL hub.",
   stretch:true,equip:true},

  {name:"Korean Air",code:"KE",logo:"🎋",
   formName:"MEDA Form",leadTime:"48 hrs prior",
   requirements:["MEDA clearance form","Medical certificate","Escort documentation","Equipment list"],
   formUrl:"https://www.koreanair.com/content/koreanair/en/travel-information/special-care.html",
   pageUrl:"https://www.koreanair.com/content/koreanair/en/travel-information/special-care.html",
   notes:"Good East Asia routing. ICN hub strong transit facilities.",
   stretch:true,equip:true},

  {name:"Japan Airlines",code:"JL",logo:"🗻",
   formName:"MEDA Form",leadTime:"48 hrs prior",
   requirements:["JAL MEDA form","Physician declaration","Escort credentials","Equipment pre-approval"],
   formUrl:"https://www.jal.co.jp/en/inter/service/medical/",
   pageUrl:"https://www.jal.co.jp/en/inter/service/medical/",
   notes:"Submit early — very process-oriented. NRT/HND routing.",
   stretch:true,equip:true},

  {name:"ANA",code:"NH",logo:"✈",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["ANA MEDIF form","Physician sign-off","Escort credentials","Equipment list"],
   formUrl:"https://www.ana.co.jp/share/assist_eng/pdf/medif.pdf",
   pageUrl:"https://www.ana.co.jp/en/au/travel-information/special-assistance/medical/",
   notes:"Submit early like JAL. Good Japan routing via NRT/HND.",
   stretch:true,equip:true},

  {name:"China Airlines",code:"CI",logo:"🐼",
   formName:"Medical Clearance Form",leadTime:"48 hrs prior",
   requirements:["Medical Clearance Form by physician","Escort documentation","Equipment pre-approval"],
   formUrl:"https://www.china-airlines.com/it/en/Images/Medical-Clearance-Form-AC-en_tcm201-3587.pdf",
   pageUrl:"https://www.china-airlines.com/au/en/fly-with-ci/special-services/special-assistance",
   notes:"TPE hub for East Asia routing.",
   stretch:true,equip:true},

  {name:"Garuda Indonesia",code:"GA",logo:"🦅",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["Garuda MEDIF form","Physician sign-off","Escort documentation","Equipment list"],
   formUrl:"https://www.garuda-indonesia.com/content/dam/garuda/files/pdf/form-medif.pdf",
   pageUrl:"https://www.garuda-indonesia.com/en/id/garuda-experience/on-ground/special-assistance",
   notes:"Indonesia routing via CGK hub.",
   stretch:true,equip:true},

  // ── EUROPE ────────────────────────────────────────────────────────────────
  {name:"British Airways",code:"BA",logo:"🎯",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF completed by physician","BA Medical clearance","Fit to fly certificate","Escort documentation"],
   formUrl:"https://www.britishairways.com/cms/global/pdfs/health/BA_Medical_Information_Form.pdf",
   pageUrl:"https://www.britishairways.com/en-gb/information/travel-assistance/medical-assistance",
   notes:"Thorough BA Medical Clearance unit. Good for Europe via LHR.",
   stretch:true,equip:true},

  {name:"Lufthansa",code:"LH",logo:"🦅",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF Part A — passenger","MEDIF Part B — physician","Equipment pre-approval","Escort credentials"],
   formUrl:"https://www.lufthansa.com/content/dam/lh/documents/fly/special-assistance/medif-form.pdf",
   pageUrl:"https://www.lufthansa.com/au/en/passenger-with-reduced-mobility",
   notes:"Efficient clearance. FRA hub connections.",
   stretch:true,equip:true},

  {name:"Air France",code:"AF",logo:"🗼",
   formName:"MEDIF Form B",leadTime:"48 hrs prior",
   requirements:["MEDIF Form B by physician","Passenger section completed","Equipment manifest","Escort documentation"],
   formUrl:"https://img.static-af.com/m/7851647b0db6ca4f/original/PMR-Form-B-EN.pdf",
   pageUrl:"https://www.airfrance.com.au/AU/en/common/guidevoyageur/pratique/assistance-passager-besoin-special-airfrance.htm",
   notes:"CDG hub for Europe–Australia. 48hr prior via Air France reservations.",
   stretch:true,equip:true},

  {name:"KLM",code:"KL",logo:"🌷",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF form","Physician certificate","Escort documentation","Equipment list"],
   formUrl:"https://www.klm.com/content/dam/klm/en/images/guides/special-assistance/MEDIF-form-en.pdf",
   pageUrl:"https://www.klm.com/au/en/information/special-assistance/medical",
   notes:"AMS hub for Europe–Australia. Efficient clearance.",
   stretch:true,equip:true},

  {name:"Turkish Airlines",code:"TK",logo:"🌙",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF signed by physician","Fit to fly certificate","Equipment declaration","Escort qualification letter"],
   formUrl:"https://www.turkishairlines.com/en-int/any-questions/travel-information/disabled-passengers/",
   pageUrl:"https://www.turkishairlines.com/en-int/any-questions/travel-information/disabled-passengers/",
   notes:"Competitive pricing for Europe routing via IST. Allow extra processing time.",
   stretch:true,equip:true},

  {name:"Finnair",code:"AY",logo:"❄️",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["Finnair MEDIF Part 1 — passenger","Finnair MEDIF Part 2 — physician","Escort credentials","Equipment manifest"],
   formUrl:"https://cms.finnair.com/resource/blob/2191774/96da9817cb423816cc3f6830f0fd2f12/medif-form-en.pdf",
   pageUrl:"https://www.finnair.com/en/special-assistance-and-health/travelling-with-medical-conditions-and-accessibility-needs",
   notes:"HEL hub for Nordic/Europe routing. Submit via Finnair special assistance form online, then attach MEDIF PDF to case.",
   stretch:true,equip:true},

  {name:"Swiss",code:"LX",logo:"🇨🇭",
   formName:"MEDIF Form",leadTime:"48 hrs prior",
   requirements:["MEDIF completed by physician","Fit to fly certificate","Equipment manifest","Escort documentation"],
   formUrl:"https://www.swiss.com/content/dam/lx/documents/SWISS-MEDIF-EN.pdf",
   pageUrl:"https://www.swiss.com/au/en/prepare/special-assistance/medical-assistance",
   notes:"ZRH hub for Europe routing. Part of Lufthansa Group, similar process.",
   stretch:true,equip:true},
];
